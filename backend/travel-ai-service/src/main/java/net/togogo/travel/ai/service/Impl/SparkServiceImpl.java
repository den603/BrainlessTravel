...
public class SparkServiceImpl implements SparkService {
     ...
     */
    @Override
    public String chat(List<net.togogo.travel.ai.dto.ChatRequest.Message> messages) throws Exception {
        ...
        for (net.togogo.travel.ai.dto.ChatRequest.Message msg : messages) {
